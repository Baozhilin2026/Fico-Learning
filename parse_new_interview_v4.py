...
def parse_interview_docx(file_path):
    ...
    while i < len(doc.paragraphs):
        ...
        # 检测答案的开始 - 支持全角冒号
        if 'Answer 英文' in text and current_question:
            # 读取英文答案
            i += 1
            answer_lines = []
        ...
        if 'Answer 中文' in text and current_question:
            # 读取中文答案
            i += 1
            answer_lines = []
    ...
    for part in parts:
        for q in part['questions']:
            if q['questionNo'] in ['Q34', 'Q41', 'Q56', 'Q57']:
                ...
                if q['questionNo'] == 'Q34' and en_len == 0:
                    print(f"  WARNING: Q34 still missing English answer!")
                    print(f"  First 100 chars of CN: {q['sampleAnswerCN'][:100]}")
