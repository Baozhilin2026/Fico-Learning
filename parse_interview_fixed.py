    ...
    while i < len(doc.paragraphs):
        ...
        if 'Answer 英文：' in text:
            ...
            while i < len(doc.paragraphs):
                ...
                # 停止条件 - 遇到"Answer 中文："就停止
                if 'Answer 中文：' in ans_text:
                    i += 1  # 跳过"Answer 中文："这一行
                    break
    ...
    for part in parts:
        for q in part['questions']:
            if q['questionNo'] in ['Q34', 'Q41', 'Q56', 'Q57']:
                ...
                if en_len > 0 and en_len < 300:
                    print(f"  EN: {q['sampleAnswer'][:100]}...")
                if cn_len > 0 and cn_len < 300:
